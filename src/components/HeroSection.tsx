...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-roboto text-lg md:text-xl lg:text-2xl mb-8 text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            Apasionado por crear contenido innovador que conecta con audiencias. 
            Especializado en <span className="text-orange">fotografía</span>, 
            <span className="text-primary"> edición de video</span> y 
            <span className="text-orange"> colorización profesional</span>.
          </p>
      ...
      {/* Floating elements */}
      <div className="absolute top-1/4 left-8 w-2 h-2 bg-primary rounded-full animate-pulse"></div>
      <div className="absolute top-1/3 right-12 w-3 h-3 bg-orange rounded-full animate-pulse delay-300"></div>
      <div className="absolute bottom-1/4 left-1/4 w-1 h-1 bg-primary rounded-full animate-pulse delay-700"></div>
    </section>
  );
};
